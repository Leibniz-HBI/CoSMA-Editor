...
curated_start_date = datetime(2021, 1, 1, tzinfo=timezone.utc)
curated_end_date = datetime(2021, 12, 31, tzinfo=timezone.utc)
curated_id_persistent = "dd98bb3f-01b5-44e2-b0de-c8324005003c"

user_name = "User Publication"
user_start_date = datetime(2021, 1, 1, tzinfo=timezone.utc)
user_end_date = datetime(2021, 12, 31, tzinfo=timezone.utc)
