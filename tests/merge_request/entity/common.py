...
time_entity_origin = datetime(1971, 1, 1, tzinfo=timezone.utc)
time_entity_origin_changed = datetime(1971, 1, 2, tzinfo=timezone.utc)
time_entity_destination = datetime(1971, 1, 3, tzinfo=timezone.utc)
time_entity_destination_changed = datetime(1971, 1, 4, tzinfo=timezone.utc)
id_merge_request_persistent = "9e222611-b58f-4da7-b684-305dd0317b3e"
time_merge_request = datetime(1974, 6, 5, tzinfo=timezone.utc)
...
time_instance_origin = datetime(1972, 2, 3, tzinfo=timezone.utc)
time_instance_origin1 = datetime(1972, 2, 4, tzinfo=timezone.utc)
time_instance_origin_curated = datetime(1972, 2, 5, tzinfo=timezone.utc)
time_instance_origin1_changed = datetime(1972, 3, 4, tzinfo=timezone.utc)
...
time_instance_destination = datetime(1972, 3, 3, tzinfo=timezone.utc)
time_instance_destination1 = datetime(1972, 3, 4, tzinfo=timezone.utc)
time_instance_destination_curated = datetime(1972, 3, 5, tzinfo=timezone.utc)
time_instance_destination_changed = datetime(1972, 3, 6, tzinfo=timezone.utc)
time_instance_destination_same_value = datetime(1972, 3, 7, tzinfo=timezone.utc)
...
time_column_changed = datetime(1973, 4, 2, tzinfo=timezone.utc)
