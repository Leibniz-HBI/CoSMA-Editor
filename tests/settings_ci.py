...
DATABASES = {
    "default": {
        ...
        "NAME": get_env("cosmae_db_name"),
        "USER": get_env("cosmae_db_user"),
        "PASSWORD": get_env("cosmae_db_password"),
        "HOST": "127.0.0.1",
        "PORT": "5432",
    }
}
...
RQ_QUEUES = {
    "default": {
        "HOST": "localhost",
        "PORT": environ.get("COSMAE_REDIS_PORT", 6333),
        "DB": 0,
        "DEFAULT_TIMEOUT": 360,
    }
}
        ...
        "APPS": [
            {
                ...
                "settings": {
                    ...
                    "advanced": {
                        ...
                        "private_key": "saml_client_private_key",
