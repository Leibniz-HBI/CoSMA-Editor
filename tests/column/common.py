...
name_column_curated_test1 = "name curated column test 1"
...
time_edit_curated_test1 = datetime(2022, 12, 23, tzinfo=timezone.utc)
...
id_column_curated_test1 = "1159411a-bf0d-4db0-a1e5-2475da4150ac"
