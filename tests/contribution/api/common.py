...
from cosmae.contribution.models_api import ContributionPostRequest

contribution_post0 = ContributionPostRequest(
    name=c.name_test0,
...
contribution_post1 = ContributionPostRequest(
    name=c.name_test1,
