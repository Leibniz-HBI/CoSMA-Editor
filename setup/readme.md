...
1. Start a container running a registry: `docker service create --name registry --publish published=5000,target=5000 registry:3`
...
5. From the base directory of the repository run
...
7. Run CoSMA-E using `USER_ID=$(id -u cosmae) GROUP_ID=$(id -g cosmae) docker stack deploy --compose-file docker-compose.yml cosmae`
