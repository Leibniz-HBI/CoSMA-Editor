...
CoSMAE addresses this gap by providing an open-source, web-based software platform for the structured, collaborative management of account lists and related metadata. The software supports entity-centered data modeling, versioning, authorship tracking, fine-grained permissions, audit logs, bulk import/export, duplicate detection, and justification fields that document inclusion decisions. These features enable multiple researchers to maintain evolving directories while preserving data provenance and accountability jointly. By centralizing updates and enabling peer review of records, CoSMAE improves data quality, reduces redundant effort, and facilitates reproducible workflows. The system is particularly suited to environments where sensitive data must be shared under controlled conditions.
...
# Software Design
The main features of the Software are the data curation, data history, and author credits. Requirements and different options for solutions were developed and discussed in a series of co-creation workshops with target users from academia and from different German research institutes in the years 2024 and 2025.
...
## Community Input
The features of *CoSMA-Editor* were suggested and refined in multiple co-creation workshops.
Without the input from those meetings, development would not have been possible.

## Funding
The CoSMA-Editor is funded by the German Federal Ministry of Education and Research under grant numbers 01UG2151A-D, 16DTM208A&B, and 16DTM404A-E
